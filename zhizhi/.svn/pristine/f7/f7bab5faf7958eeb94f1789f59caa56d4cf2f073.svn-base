...
import com.zhizhi.common.tools.ToolContext;
import com.zhizhi.common.tools.ToolDateTime;
import com.zhizhi.sys.operator.model.Operator;
import com.zhizhi.sys.operator.model.Role;
import com.zhizhi.sys.system.model.SysLog;
...
public class AuthenticationInterceptor implements Interceptor {
	...
	public void intercept(Invocation ai) {
		...
		//
		if(uri.contains("/test")||uri.contains("/websocket")){
			log.info("URI免验证!");
